...
Gem::Specification.new do |spec|
  spec.name          = "simon-heisterkamps-blog"
  spec.version       = "1.0.0"
  spec.authors       = ["Simon Heisterkamp"]
  spec.email         = ["simon@heisterkamp.dk"]

  spec.summary       = %q{Simon Heisterkamp blog}
  spec.description   = "Simon Heisterkamp blog"
  spec.homepage      = "https://heisterkamp.dk"
  spec.license       = "MIT"
